                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            ...
                            <div className="grid md:items-start md:flex md:flex-col gap-6 md:gap-3">
                                ...
                                <p className="text-kaiglo_grey-base">
                                    Your trust in Kaiglo.com is highly valued. Thus, we have implemented the
                                    best standards for secure transactions and customer information privacy.
                                </p>
                                <Link
                                    href={"/"}
                    ...
                    <section className="p-4 bg-kaiglo_grey-50 py-10 md:py-20 ">
                        ...
                        <div className="grid md:grid-cols-3 gap-4 mt-6 lg:mx-8">
                            <section className="flex flex-col gap-4 md:gap-2 border border-kaiglo_grey-disabled bg-kaiglo_grey-50 md:bg-white py-5 px-4 rounded-lg">
                                ...
                                <p className="text-kaiglo_grey-base">
                                    Quality products at the best affordable prices Multiple varieties of each
                                    products Fast and convenient delivery
                                </p>
                            </section>
                            <section className="flex flex-col gap-4 md:gap-2 border border-kaiglo_grey-disabled bg-kaiglo_grey-50 md:bg-white py-5 px-4 rounded-lg">
                                <figure className="bg-kaiglo_grey-50 font-bold flex items-center justify-center w-12 h-12 border border-kaiglo_grey-disabled rounded-lg">
                                ...
                                <p className="text-kaiglo_grey-base">
                                    ...
                                    manufacturer's prices. Creating multiple channels where manufacturers can
                                    have access to millions of Africans.
                                </p>
                            </section>
                            <section className="flex flex-col gap-4 md:gap-2 border border-kaiglo_grey-disabled bg-kaiglo_grey-50 md:bg-white py-5 px-4 rounded-lg">
                                <figure className="bg-kaiglo_grey-50 font-bold flex items-center justify-center w-12 h-12 border border-kaiglo_grey-disabled rounded-lg">
                                ...
                                <p className="text-kaiglo_grey-base">
                                    Continuous and never ending technological research and development for
                                    exploring the ecommerce marketplace in Nigeria, and Africa.
                                </p>
                            </section>
                        </div>
                    </section>
