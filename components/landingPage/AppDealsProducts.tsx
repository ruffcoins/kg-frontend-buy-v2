...
const AppDealsProducts = () => {
    ...
    if (appDealsProductsError) {
        return (
            <ErrorComponent message="Failed to load app deals products." action={refetchAppDealsProducts} />
        );
    }
        ...
        appDealsProducts?.length > 0 && (
            <div className="lg:px-8 px-4 space-y-5">
                <div className="flex justify-between items-center">
                    <h1 className="font-medium text-base lg:text-[32px]">App Exclusive Deals - 50% OFF</h1>
                    <Button
                        variant="info"
