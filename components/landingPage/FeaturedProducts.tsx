...
const FeaturedProducts = () => {
    ...
    if (featuredProductsError) {
        return (
            <ErrorComponent message="Failed to load featured products." action={refetchFeaturedProducts} />
        );
    }
        ...
        featuredProducts?.length > 0 && (
            <div className="lg:lg:px-8 px-4 space-y-5">
                <div className="flex justify-between items-center">
                    <h1 className="font-medium text-base lg:text-[32px]">Featured Products</h1>
                    <Button
                        variant="purple"
