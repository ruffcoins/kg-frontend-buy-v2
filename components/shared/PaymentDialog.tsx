...
import { cn, getKlumpPayloadItems, getPhoneNumWithoutCountryCode } from "@/lib/utils";
...
const PaymentDialog = ({
    ...
    const handlePayment = async () => {
        ...
        if (selectedMethod === "klump") {
            ...
            const klumpEmail = process.env.NODE_ENV === "production" ? userDetails.email : "sample@mail.com";
    ...
    const handleAbandonOrder = async () => {
        const abandonedOrderPayload: AbandonedOrderDTO = {
            ...
            platform: "WEB",
            productIds: transformedCartItems.map((item) => item.orderLines[0].orderItem.productId),
            shipping: shippingAmount,
            userId: user.id,
        };
        ...
        <>
            ...
            >
                <DialogContent className="lg:w-[552px]">
                    <DialogHeader>
                        <DialogTitle className="text-start lg:text-center">Select Payment Method</DialogTitle>
                        <DialogDescription />
                    </DialogHeader>
                    <div className="space-y-6 py-4">
                        ...
                        >
                            <input type="radio" checked={selectedMethod === "klump"} readOnly />
                        ...
                        >
                            <div className="flex space-x-4">
                                <input
                                    ...
                                    readOnly
                                    disabled={fetchingWallet || !wallet || totalAmount > wallet?.amount}
